  ...
  return (
    <BlankCard>
      <CardContent sx={{ p: '25px' }}>
        <Typography variant="h5">Peak Load MW</Typography>

        <Grid container spacing={3}>
          <Grid item xs={5} sx={{ paddingRight: '10px' }}>
            <Typography variant="h4" mt={3} fontWeight={600}>9.4 MW</Typography>
